                    ...
                    <Col xxl={4} md={6} sm={8}>
                        <Card className="p-4">
                            ...
                            <div className="auth-brand text-center mb-4">
                                <AppLogo />
                                <p className="text-muted w-lg-75 mt-3 mx-auto">Chào mừng bạn đến với Intraspace. Tạo tài khoản để bắt đầu.</p>
                            </div>
                            ...
                            <Form onSubmit={handleSubmit}>
                                ...
                                <div className="d-grid">
                                    <Button type="submit" className="btn btn-primary fw-semibold py-2" disabled={loading}>
                                        {loading ? <><Spinner size="sm" className="me-2" />Đang tạo tài khoản...</> : 'Tạo tài khoản'}
                                    </Button>
                                </div>
                            </Form>
                            ...
                            <p className="text-muted text-center mt-4 mb-0">
                                Đã có tài khoản?{' '}
                                <Link href="/login" className="text-decoration-underline link-offset-3 fw-semibold">
                                    Đăng nhập
                                </Link>
                            </p>
                        </Card>
